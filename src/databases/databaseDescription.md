...
```
--------------------------------------------------
### 2. CSE103_Fall14_achievement_user
***Description***:
...
```
--------------------------------------------------
### 3. CSE103_Fall14_answers_by_part
***Description***:
...
```
--------------------------------------------------
### 5. CSE103_Fall14_assigned_hint_feedback
***Description***:
...
```
--------------------------------------------------
### 6. CSE103_Fall14_assigned_hint_filter
***Description***:
...
```
--------------------------------------------------
### 7. CSE103_Fall14_correct_answers
***Description***:
...
```
  | Field      | Type          | Null | Key | Default | Extra
--|------------|---------------|------|-----|---------|------
0 | set_id     | varchar(1024) | NO   | MUL | None    |      
1 | problem_id | int(11)       | NO   | MUL | None    |      
2 | user_id    | varchar(1024) | NO   | MUL | None    |      
3 | part_id    | int(11)       | NO   | MUL | None    |      
4 | answer     | varchar(1024) | YES  |     | None    |      
```
--------------------------------------------------
### 8. CSE103_Fall14_global_user_achievement
***Description***:
...
6 | deleted    | tinyint(1)   | YES  |     | 0                 |                            
7 | part_id    | int(11)      | YES  |     | None              |                            
```
--------------------------------------------------
### 10. CSE103_Fall14_hint_filter
***Description***:
...
```
--------------------------------------------------
### 17. CSE103_Fall14_realtime_past_answer
***Description***:
...
```
--------------------------------------------------
### 19. CSE103_Fall14_set_locations
***Description***:
...
```
--------------------------------------------------
### 20. CSE103_Fall14_set_locations_user
***Description***:
...
```
--------------------------------------------------
### 24. CSE103_Fall14_user_variables
***Description***:
...
1 | problem_id | int(11)       | NO   | MUL | None    |      
2 | user_id    | varchar(1024) | NO   | MUL | None    |      
3 | name       | varchar(1024) | NO   | MUL | None    |      
4 | value      | float         | YES  |     | None    |      
5 | value_f    | float         | NO   |     | None    |      
6 | string     | varchar(1024) | YES  |     | None    |      
```
--------------------------------------------------
### 25. CSE103_Fall15_answers_by_part
***Description***:
...
```
--------------------------------------------------
### 26. CSE103_Fall2015_achievement
***Description***:
...
```
--------------------------------------------------
### 27. CSE103_Fall2015_achievement_user
***Description***:
...
```
--------------------------------------------------
### 28. CSE103_Fall2015_answers_by_part
***Description***:
...
```
--------------------------------------------------
### 29. CSE103_Fall2015_assigned_hint
***Description***:
...
```
--------------------------------------------------
### 30. CSE103_Fall2015_assigned_hint_feedback
***Description***:
...
```
--------------------------------------------------
### 31. CSE103_Fall2015_assigned_hint_filter
***Description***:
...
```
--------------------------------------------------
### 32. CSE103_Fall2015_correct_answers
***Description***:
...
```
--------------------------------------------------
### 33. CSE103_Fall2015_global_user_achievement
***Description***:
...
```
--------------------------------------------------
### 35. CSE103_Fall2015_hint_filter
***Description***:
...
```
--------------------------------------------------
### 38. CSE103_Fall2015_past_answer
***Description***:
...
```
--------------------------------------------------
### 41. CSE103_Fall2015_problem_user
***Description***:
...
```
--------------------------------------------------
### 42. CSE103_Fall2015_realtime_past_answer
***Description***:
...
```
--------------------------------------------------
### 44. CSE103_Fall2015_set_locations
***Description***:
...
```
--------------------------------------------------
### 45. CSE103_Fall2015_set_locations_user
***Description***:
...
```
--------------------------------------------------
### 49. CSE103_Fall2015_user_variables
***Description***:
